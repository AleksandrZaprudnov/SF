...
def print_str_field(tpf, l = []):
    return "║" + ''.join(map(lambda x: ''.join(map(lambda s: " " + str(s[1]) + " ║" \
        if int(s[0]) in l else '', x.items())), tpf))
# End: print_str_field()
...
def rend_field(tpf):
    ...
    print(f'╔═══╦═══╦═══╗{str_tab}╔═══╦═══╦═══╗')
    print(f'{print_str_field(tpf, [1, 2, 3])}{str_tab}║ 1 ║ 2 ║ 3 ║')
    print(f'║═══╬═══╬═══║{str_tab}║═══╬═══╬═══║')
    print(f'{print_str_field(tpf, [4, 5, 6])}{str_tab}║ 4 ║ 5 ║ 6 ║')
    print(f'║═══╬═══╬═══║{str_tab}║═══╬═══╬═══║')
    print(f'{print_str_field(tpf, [7, 8, 9])}{str_tab}║ 7 ║ 8 ║ 9 ║')
    print(f'╚═══╩═══╩═══╝{str_tab}╚═══╩═══╩═══╝')
# End: rend_field()
